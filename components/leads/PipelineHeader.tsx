  ...
  return (
    <div className="p-0 pb-2 space-y-5">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        {/* 🛠️ UPGRADED DESEGREGATION MODULE: Stripped manual override button link blocks entirely */}
        <div className="flex items-center gap-5 bg-muted/40 p-2.5 rounded-xl border border-border/40 self-start md:self-auto shadow-sm">
          ...
          {lead.status === 'won' ? (
            ...
            <div className="text-xs font-bold text-primary bg-primary/10 px-3 py-1.5 rounded-lg flex items-center gap-1 border border-primary/20 select-none">
              <Sparkles className="h-3.5 w-3.5" /> Deal Active
            </div>
          )}
        </div>
      </div>
